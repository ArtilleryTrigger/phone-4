...
pip3 install boto3
dnf install git -y
echo "osvaldo-phonebook-18.cpcgekum22zy.us-east-1.rds.amazonaws.com" > /home/ec2-user/dbserver.endpoint
cd /home/ec2-user
...
git clone https://$TOKEN@github.com/ArtilleryTrigger/phone-4.git
